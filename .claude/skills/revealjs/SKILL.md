...
```bash
node .claude/skills/revealjs/scripts/create-presentation.js --structure 1,1,d,3,1,d,1 --title "My Presentation" --output slides/index.html
```
...
node .claude/skills/revealjs/scripts/create-presentation.js --slides 10 --output slides/index.html

# Mixed structure: intro, 2 content slides, divider, 3-slide vertical stack, divider, closing
node .claude/skills/revealjs/scripts/create-presentation.js --structure 1,1,1,d,3,d,1 --title "Q4 Review" --output slides/index.html
```
...
```bash
node .claude/skills/revealjs/scripts/edit-html.js slides/index.html
```
